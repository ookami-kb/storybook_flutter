...
Future<void> loadAppFonts() async {
  ...
  final fontManifest = await rootBundle.loadStructuredData<Iterable<dynamic>>(
    'FontManifest.json',
    (string) async => json.decode(string) as Iterable<Map<String, dynamic>>,
  ...
  for (final Map<String, dynamic> font in fontManifest) {
    ...
    for (final Map<String, dynamic> fontType
        in font['fonts'] as Iterable<Map<String, dynamic>>) {
...
String derivedFontFamily(Map<String, dynamic> fontDefinition) {
  ...
  if (fontFamily.startsWith('packages/')) {
    ...
    for (final Map<String, dynamic> fontType
        in fontDefinition['fonts'] as Iterable<Map<String, dynamic>>) {
